...
- (void)presentPopupControllerAnimated:(BOOL)flag {
    ...
    [UIView animateWithDuration:flag?self.theme.animationDuration:0.0 delay:0 usingSpringWithDamping:0.75 initialSpringVelocity:0.5 options:UIViewAnimationOptionCurveEaseOut animations:^{
...
- (void)dismissPopupControllerAnimated:(BOOL)flag {
    ...
    [UIView animateWithDuration:flag?self.theme.animationDuration:0.0 delay:0 usingSpringWithDamping:0.7 initialSpringVelocity:0.5 options:UIViewAnimationOptionCurveEaseIn animations:^{
