...
@class LBSegmentControl;
@protocol LBSegmentControlDelegate<NSObject>

@optional
- (void)segment:(LBSegmentControl *)segment didMoveToIndex:(NSInteger)index viewController:(UIViewController *)controller;
...
/**
 代理
 */
@property (nonatomic, weak) id<LBSegmentControlDelegate> delegate;
